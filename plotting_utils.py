...
def plot_current_profile(current_profile: list[float], duration_profile: list[float], save_path: str | None = None):
...
def plot_voltage_profile(voltage_profile: list[float], duration_profile: list[float], save_path: str | None = None):
...
def plot_voltage_and_current_profile(voltage_profile: list[float], current_profile: list[float], duration_profile: list[float], save_path: str | None = None):
